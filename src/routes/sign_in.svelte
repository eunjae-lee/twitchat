...
<div class="container mx-auto max-w-xs md:max-w-sm h-screen flex flex-col justify-center">
	<div class="flex flex-col">
		<div class="self-center"><img class="w-12" src="/logo-big.png" alt="TwitChat Logo" /></div>
		<h1 class="mt-8 text-4xl font-bold text-center">{t('h1')}</h1>
		<button class="mt-16 btn btn-lg btn-primary" on:click={signInWithTwitter}>
			<svg
				version="1.1"
